...
const About = () => {
  ...
  return (
    <>
      <div
        className="bg-black w-100 md:pl-20 p-5 h-14 lg:hidden flex items-center sticky top-0"
        
      >
        ABOUT ME
      </div>
      <section className="text-left flex flex-col" id="about">
        <div className="md:pt-20 md:pr-20 md:pb-20 p-5 text-slate-400">
          ...
          <p>
            ...
            , and celebrate weekends with the thrill of
            <span
              className="pl-1 sm:font-bold sm:cursor-none sm:text-slate-300"
